...
<body >
<div class="container">
    <section class="content content_content" style="width:30%; margin: auto;">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
										...
										<?php
											...
											<tr>
                                                <th>Tax:</th>
                                                <td align="right"> <?php echo formatMoney($total*.15,true); ?></td>
                                            </tr>
											<tr >
											<tr>
                                                <th>Total:</th>
                                                <td align="right"> <?php echo formatMoney($total+$total*.15,true);?></td>
                                            </tr>
											...
											<tr>
                                                <th></th>
                                                <td align="right"> <?php echo formatMoney(($total+($total*.15))-$dis,true); ?></td>
                                            </tr>
											...
											<tr>
                                                <th>Balance:</th>
                                                <td align="right"> <?php echo formatMoney($pay-$amount1,true); ?></td>
                                            </tr>
